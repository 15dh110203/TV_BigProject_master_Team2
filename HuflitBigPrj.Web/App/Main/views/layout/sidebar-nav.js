    ...
    angular.module('app').controller(controllerId, [
        ...
        function ($rootScope, $state, appSession) {
            ...
            vm.menuItems = [
                ...
                createMenuItem(App.localize("Payment"), "", "info", "payment"),
                createMenuItem(App.localize("Customer"), "", "info", "customer"),
                createMenuItem(App.localize("Inventory"), "", "info", "inventory"),
                createMenuItem(App.localize("PurchaseOrders"), "", "info", "purchaseorder"),
